...
import { readUint16LE, readUint32LE, defaultLogger } from "@bundle:com.craft.runtime/entry/ets/craft/core/utils";
...
export class APKParser {
     ...
     */
    private parseEOCD(data: Uint8Array, offset: number): {
        cdOffset: number;
        cdEntryCount: number;
    } {
