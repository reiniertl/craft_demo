import { DexParser } from "@bundle:com.craft.runtime/entry/ets/craft/parser/dex_parser";
import { ManifestParser } from "@bundle:com.craft.runtime/entry/ets/craft/parser/manifest_parser";
import type { ManifestInfo } from "@bundle:com.craft.runtime/entry/ets/craft/parser/manifest_parser";
import { Heap } from "@bundle:com.craft.runtime/entry/ets/craft/interpreter/heap";
import { Interpreter } from "@bundle:com.craft.runtime/entry/ets/craft/interpreter/interpreter";
import type { ClassLoader } from './interpreter/class_loader';
import type { ShimRegistry } from './interpreter/shim_registry';
import { initializeShimRegistry } from "@bundle:com.craft.runtime/entry/ets/craft/interpreter/shim_init";
import { UIBridge } from "@bundle:com.craft.runtime/entry/ets/craft/bridge/ui_bridge";
import { StateManager } from "@bundle:com.craft.runtime/entry/ets/craft/bridge/state_manager";
import type { ViewState } from "@bundle:com.craft.runtime/entry/ets/craft/bridge/state_manager";
import { LifecycleBridge } from "@bundle:com.craft.runtime/entry/ets/craft/bridge/lifecycle_bridge";
import { APKParser } from "@bundle:com.craft.runtime/entry/ets/craft/parser/apk_parser";
import type { APKContents } from "@bundle:com.craft.runtime/entry/ets/craft/parser/apk_parser";
/**
...
export class CraftRuntime {
    ...
    private loadAPKContents(apkContents: APKContents): void {
        ...
        this.interpreter = new Interpreter(this.dexParser, this.heap, this.shimRegistry);
