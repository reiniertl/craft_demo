...
import type { Heap } from '../interpreter/heap';
...
export class LifecycleBridge {
    ...
    createActivity(mainClass: string): number {
        ...
        // Call Activity.<init>()
        this.interpreter.invoke(mainClass, '<init>', '()V', [{ type: 'object', ref: this.activityRef }]);
        // Call Activity.onCreate(null)
        this.interpreter.invoke(mainClass, 'onCreate', '(Landroid/os/Bundle;)V', [{ type: 'object', ref: this.activityRef }, NULL_VALUE]);
    ...
    resumeActivity(): void {
        ...
        // Call onStart()
        this.interpreter.invoke(this.mainClassName, 'onStart', '()V', [{ type: 'object', ref: this.activityRef }]);
        // Call onResume()
        this.interpreter.invoke(this.mainClassName, 'onResume', '()V', [{ type: 'object', ref: this.activityRef }]);
    }
    /**
    ...
    pauseActivity(): void {
        ...
        // Call onPause()
        this.interpreter.invoke(this.mainClassName, 'onPause', '()V', [{ type: 'object', ref: this.activityRef }]);
        // Call onStop()
        this.interpreter.invoke(this.mainClassName, 'onStop', '()V', [{ type: 'object', ref: this.activityRef }]);
    }
    /**
    ...
    destroyActivity(): void {
        ...
        // Call onDestroy()
        this.interpreter.invoke(this.mainClassName, 'onDestroy', '()V', [{ type: 'object', ref: this.activityRef }]);
        // Clear references
