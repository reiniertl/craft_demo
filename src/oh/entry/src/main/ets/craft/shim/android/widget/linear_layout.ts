/**
 * CRAFT - android.widget.LinearLayout Shim
...
export function registerLinearLayoutShim(registry: ShimRegistry, uiBridge?: UIBridge): void {
  ...
  registry.register(LINEAR_LAYOUT_CLASS, '<init>',
  ...
  // setOrientation(I)V
  registry.register(LINEAR_LAYOUT_CLASS, 'setOrientation', '(I)V',
    (_interp, heap, thisRef, args) => {
  ...
  // getOrientation()I
  registry.register(LINEAR_LAYOUT_CLASS, 'getOrientation', '()I',
